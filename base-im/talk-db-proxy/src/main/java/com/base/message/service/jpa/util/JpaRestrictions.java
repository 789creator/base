package com.base.message.service.jpa.util;
...
public class JpaRestrictions {
    ...
    public static SimpleExpression like(String fieldName, String value, MatchMode matchMode, boolean ignoreNull) {
        ...
        switch (matchMode) {
            case START:
                expression = new SimpleExpression(fieldName, value, Criterion.Operator.LLIKE);
                break;
            case END:
                expression = new SimpleExpression(fieldName, value, Criterion.Operator.RLIKE);
                break;
            case ANYWHERE:
                expression = new SimpleExpression(fieldName, value, Criterion.Operator.LIKE);
                break;
            default:
                expression = new SimpleExpression(fieldName, value, Criterion.Operator.LIKE);
                break;
    ...
    public static SimpleExpression isNotNull(String fieldName) {
        return new SimpleExpression(fieldName, Criterion.Operator.NOTNULL);
    }
    ...
    public static SimpleExpression rlike(String fieldName, String value, boolean ignoreNull) {
        if (StringUtils.isEmpty(value))
            return null;
        return new SimpleExpression(fieldName, value, Criterion.Operator.RLIKE);
    }
    ...
    public static SimpleExpression llike(String fieldName, String value, boolean ignoreNull) {
        if (StringUtils.isEmpty(value))
            return null;
        return new SimpleExpression(fieldName, value, Criterion.Operator.LLIKE);
    }
}
