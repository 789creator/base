...
package com.base.message.common.util;
...
public class SequenceNumberUtils {
    ...
    private static SequenceNumberUtils maker = new SequenceNumberUtils();

    private SequenceNumberUtils() {
    }

    public static SequenceNumberUtils getInstance() {
        return maker;
    }
     ...
     * */
     public int makelocalUniqueMsgId(){
        synchronized(SequenceNumberUtils.this) {
