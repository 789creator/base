...
import com.base.message.server.manager.ClientUser;
import com.base.message.server.manager.ClientUserManager;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

import com.base.message.common.code.DefaultIMHeader;
...
import com.base.message.common.code.proto.IMBaseDefine.KickReasonType;
import com.base.message.common.code.proto.IMBaseDefine.LoginCmdID;
import com.base.message.common.code.proto.IMBaseDefine.OtherCmdID;
import com.base.message.common.code.proto.IMBaseDefine.ResultType;
import com.base.message.common.code.proto.IMBaseDefine.ServiceID;
import com.base.message.common.code.proto.IMBaseDefine.UserStatType;
import com.base.message.common.code.proto.IMLogin.IMDeviceTokenReq;
import com.base.message.common.code.proto.IMLogin.IMDeviceTokenRsp;
import com.base.message.common.code.proto.IMLogin.IMKickPCClientReq;
import com.base.message.common.code.proto.IMLogin.IMKickPCClientRsp;
import com.base.message.common.code.proto.IMLogin.IMLoginReq;
import com.base.message.common.code.proto.IMLogin.IMLoginRes;
import com.base.message.common.code.proto.IMLogin.IMLogoutReq;
import com.base.message.common.code.proto.IMLogin.IMLogoutRsp;
import com.base.message.common.code.proto.IMLogin.IMPushShieldReq;
import com.base.message.common.code.proto.IMLogin.IMPushShieldRsp;
import com.base.message.common.code.proto.IMLogin.IMQueryPushShieldReq;
import com.base.message.common.code.proto.IMLogin.IMQueryPushShieldRsp;
import com.base.message.common.code.proto.IMServer.IMServerKickUser;
import com.base.message.common.code.proto.helper.JavaBean2ProtoBuf;
import com.base.message.common.model.BaseModel;
import com.base.message.common.model.entity.UserEntity;
import com.base.message.common.param.KickUserReq;
import com.base.message.common.param.LoginReq;
import com.base.message.common.param.UserToken;
import com.base.message.common.result.LoginCmdResult;
import com.base.message.common.util.CommonUtils;
import com.base.message.server.cluster.MessageServerCluster;
import com.base.message.server.handler.IMLoginHandler;
...
import com.base.message.server.remote.LoginService;
...
//        ResponseEntity<String> userList = restTemplate.getForEntity("http://localhost:10060/user/search/findByName", String.class, params);
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMLoginHandler#logOut(com.base.message.common.code.proto.Header, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMLoginHandler#kickUser(com.base.message.common.code.proto.Header, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    //不在该处实现
    @Override
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMLoginHandler#deviceToken(com.base.message.common.code.proto.Header, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMLoginHandler#kickPcClient(com.base.message.common.code.proto.Header, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMLoginHandler#pushShield(com.base.message.common.code.proto.Header, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMLoginHandler#queryPushShield(com.base.message.common.code.proto.Header, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
