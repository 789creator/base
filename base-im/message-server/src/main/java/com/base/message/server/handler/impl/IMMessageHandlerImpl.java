...
import com.base.message.common.code.proto.IMBaseDefine.MessageCmdID;
import com.base.message.common.code.proto.IMBaseDefine.MsgType;
import com.base.message.common.code.proto.IMBaseDefine.ServiceID;
import com.base.message.common.code.proto.IMBaseDefine.SessionType;
import com.base.message.common.code.proto.IMBaseDefine.UserStat;
import com.base.message.common.code.proto.IMBaseDefine.UserStatType;
import com.base.message.common.code.proto.IMBaseDefine.UserTokenInfo;
import com.base.message.common.code.proto.IMMessage;
import com.base.message.common.code.proto.IMMessage.IMMsgData;
import com.base.message.common.code.proto.IMServer.IMPushToUserReq;
import com.base.message.common.code.proto.helper.JavaBean2ProtoBuf;
import com.base.message.common.constant.DBConstant;
import com.base.message.common.constant.MessageConstant;
import com.base.message.common.constant.PushConstant;
import com.base.message.common.model.BaseModel;
import com.base.message.common.model.MessageEntity;
import com.base.message.common.model.entity.GroupPushEntity;
import com.base.message.common.model.entity.ShieldStatusEntity;
import com.base.message.common.model.entity.UnreadEntity;
import com.base.message.common.param.ClearUserCountReq;
import com.base.message.common.param.GroupMessageSendReq;
import com.base.message.common.param.IosPushReq;
import com.base.message.common.param.MessageSendReq;
import com.base.message.common.param.UserToken;
import com.base.message.common.result.GroupCmdResult;
import com.base.message.common.util.CommonUtils;
import com.base.message.common.util.SecurityUtils;
import com.base.message.server.cluster.MessageServerCluster;
import com.base.message.server.handler.IMMessageHandler;
import com.base.message.server.remote.GroupService;
import com.base.message.server.remote.IphonePushService;
...
import com.base.message.server.remote.MessageService;
...
public class IMMessageHandlerImpl extends AbstractUserHandlerImpl implements IMMessageHandler {
     ...
     * 
     * @see
     * com.blt.talk.message.server.handler.IMMessageHandler#sendMessage(com.base.message.common.code.
...
//                // 推送其他Server用户
     ...
     * 
     * @see
     * com.blt.talk.message.server.handler.IMMessageHandler#readMessage(com.base.message.common.code.
     * IMHeader, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
     ...
     * 
     * @see
     * com.blt.talk.message.server.handler.IMMessageHandler#getUnreadCount(com.base.message.common.code.
     * IMHeader, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
     ...
     * 
     * @see
     * com.blt.talk.message.server.handler.IMMessageHandler#getMessageList(com.base.message.common.code.
     * IMHeader, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMMessageHandler#getLatestMessageId(com.base.message.common.code.IMHeader, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMMessageHandler#getByMessageId(com.base.message.common.code.IMHeader, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.blt.talk.message.server.handler.IMMessageHandler#clientMsgDataAck(com.base.message.common.code.IMHeader, com.google.protobuf.MessageLite, io.netty.channel.ChannelHandlerContext)
     */
    @Override
