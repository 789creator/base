...
package com.base.message.server.config;
...
@Configuration
@EnableCaching
@AutoConfigureAfter(value = {MessageServerConfig.class})
public class HazelCastConfigration {
    ...
    private MapConfig initializeDomainMapConfig(MessageServerConfig serverConfig) {
        MapConfig mapConfig = new MapConfig();
