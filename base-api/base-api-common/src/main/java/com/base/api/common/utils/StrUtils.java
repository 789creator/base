...
public class StrUtils extends StringUtils {
    ...
    public static boolean isMobile(String mobile)
    {
        try
        {
            Pattern p = Pattern.compile(
                    "13[0-9]{9}$|14[5,7]{1}[0-9]{8}$|15[0-9]{9}$|16[0-9]{9}$|17[0,1,6,7,8,3]{1}[0-9]{8}$|18[0-9]{9}$|19[0-9]{9}$");
    ...
    {
        return StrUtils.maskString(identityNumber, StrUtils.ASTERISK, 6, 4);
    }
    ...
    {
        return StrUtils.maskString(identityNumber, StrUtils.ASTERISK, 3, 4);
    }

    /**
     * 掩码 银行卡号
     */
    public static String maskCardNumber(String bankNumber)
    {
        return StrUtils.maskString(bankNumber, StrUtils.ASTERISK, 5, 4);
    }
