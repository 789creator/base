package com.base.sso.core.shiro.config;


import com.base.sso.core.shiro.filter.UpmsAuthenticationFilter;
import com.base.sso.core.shiro.filter.UpmsSessionForceLogoutFilter;
import com.base.sso.core.shiro.listener.UpmsSessionListener;
import com.base.sso.core.shiro.realm.SsoRealm;
import com.base.sso.core.shiro.session.UpmsSessionDao;
import com.base.sso.core.shiro.session.UpmsSessionFactory;
...
public class ShiroConfig {
    ...
    //将自己的验证方式加入容器
    @Bean
    public SsoRealm upmsRealm() {
        SsoRealm upmsRealm = new SsoRealm();
        return upmsRealm;
    }
...
//        factoryBean.setFilterChainDefinitions(filterChainDefinitions);
    ...
    @Bean
    public SecurityManager securityManager(SsoRealm upmsRealm, SessionManager sessionManager, RememberMeManager rememberMeManager) {
